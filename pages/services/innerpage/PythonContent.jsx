...
const PythonContent = () => {
  return (
    <div className=" text-zinc-500 body-font container mx-auto  px-5 py-10 mb-10">
      ...
      <Desc
        desc="We are a flat hierarchy order company extending the freedom to innovate and research to every member of our team making it a collaborative endeavour. We are passionate for what we do and encourage a happy mind attitude creating a transparent and fully functional work atmosphere."
      />
