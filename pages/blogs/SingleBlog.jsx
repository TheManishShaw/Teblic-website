  ...
  return (
    <div className=" rounded-xl shadow-xl bg-white hover:scale-105 hover:ease-in-out transition-all">
      ...
      <p className="mt-3 px-9 text-xs font-semibold tracking-wide uppercase">
        <a  className="transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800" aria-label="Category" >
         {props.category}
        </a>{" "}
        <span className="text-gray-600">— {props.date}</span>
      </p>
      <header className=" text-xl font-bold p-3 px-9">
        {props.title}
      </header>
      <div className="px-5">
