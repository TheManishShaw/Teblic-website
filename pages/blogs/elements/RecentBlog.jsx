      ...
      <div className="w-full lg:w-4/12 px-5 py-4 h-auto">
        <div>
          <div className="flex flex-wrap -mx-4 mb-8">
            ...
            <div className="w-full md:w-1/2 lg:w-full px-4">
              <div
                ...
                <div className="w-full">
                  <h4>
                    <a href="javascript:void(0)" className=" text-lg lg:text-base xl:text-lg leading-snug font-medium text-dark hover:text-primary mb-1 inline-block" >
            ...
            <div className="w-full md:w-1/2 lg:w-full px-4">
              <div className=" w-full flex items-center pb-5 mb-5 border-b border-[#F2F3F8] wow fadeInUp" data-wow-delay=".1s " >
                <div className=" w-full max-w-[80px] h-20 rounded-full overflow-hidden mr-5">
                  <img src="/favicon.png" alt="image" className="w-full" />
                </div>
                <div className="w-full">
